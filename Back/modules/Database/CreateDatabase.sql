...
CREATE TABLE `Cities` (
  ...
  CONSTRAINT `Countries_id` FOREIGN KEY (`Countries_id`) REFERENCES `Contries` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `School_to_cities` (
  ...
  CONSTRAINT `Cities_id` FOREIGN KEY (`Cities_id`) REFERENCES `Cities` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
